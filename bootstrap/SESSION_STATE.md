# Current Session State — Stillpeak's Grieving Heart

This file represents the authoritative live-play baseline for both the DM Runtime Project and the Ideation / Design Project.

It should always reflect the most recent agreed-upon table state.
...
- Location (packet or segment)
- Party level or major condition
- Significant deviation from canon
- Acquisition or loss of key items or clues
- End-of-session pause point

This file should always match the latest session log and live table reality.
